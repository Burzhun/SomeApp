...
class Article extends CActiveRecord
{
	...
	{
return Yii::app()->createurl('article/view', array('id' => $this->id, 'translit' => Translit::url($this->title)));
	}
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, title, content, short,image, date, position, seokeywords, seotitle, seodescription', 'safe' ),
		);
	}
